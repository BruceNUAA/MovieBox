...
public class NowPlayingMovieAdapter extends RecyclerView.Adapter<NowPlayingMovieAdapter.UpcomingMovieViewHolder>{

    private Context context;
    private List<NowPlayingMovieResponse.Result> movieList;
    int previousposition =0;

    public NowPlayingMovieAdapter(Context context, List<NowPlayingMovieResponse.Result> movieList) {
