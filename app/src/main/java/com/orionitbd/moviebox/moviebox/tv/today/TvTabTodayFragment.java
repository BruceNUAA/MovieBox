...
public class TvTabTodayFragment extends Fragment {
    ...
    private TodayTvService service;
    private List<TodayTvResponse.Result> tvResponseList;
    private TodayTvAdpater adapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView = v.findViewById(R.id.todayTvRV);
        progressBar = v.findViewById(R.id.pb7);
        recyclerView.setVisibility(View.GONE);
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl(BASE_URL)
                .addConverterFactory(GsonConverterFactory.create())
                .build();
        service = retrofit.create(TodayTvService.class);

        Call<TodayTvResponse> call = service.getTodayResponse (getString(R.string.API_KEY),LANGUAGE,PAGE);
        call.enqueue(new Callback<TodayTvResponse> () {
            ...
            public void onResponse(Call<TodayTvResponse> call, Response<TodayTvResponse> response) {
                if(response.code()==200){
                    ...
                    adapter = new TodayTvAdpater (getContext(),tvResponseList);
