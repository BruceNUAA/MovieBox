...
public class SimilerMovieAdapter extends RecyclerView.Adapter<MovieViewHolder>{

    private Context context;
    private List<SimilerMovieResponse.Result> movieList;
    int previousposition =0;


    public SimilerMovieAdapter(Context context, List<SimilerMovieResponse.Result> movieList) {
