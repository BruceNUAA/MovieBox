...
public class TopRatedMovieAdapter extends RecyclerView.Adapter<TopRatedMovieAdapter.UpcomingMovieViewHolder>{

    private Context context;
    private List<TopRatedMovieResponse.Result> movieList;
    int previousposition =0;

    public TopRatedMovieAdapter(Context context, List<TopRatedMovieResponse.Result> movieList) {
