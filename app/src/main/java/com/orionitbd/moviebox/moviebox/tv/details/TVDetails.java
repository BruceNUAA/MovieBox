...
import com.orionitbd.moviebox.moviebox.tv.DetailsTVActivity;
...
public class TVDetails {
    ...
    public static void getDetails(final Context context , Long id ){
        ...
        Retrofit retrofit = new Retrofit.Builder()
                ...
                .build();
        TVDetailsService service = retrofit.create(TVDetailsService.class);
        Call<TVDetailsResponse> call = service.getDetails(id,key, LANGUAGE);
